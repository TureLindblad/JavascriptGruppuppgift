...
const Restaurants = [
  {
    id: 1,
    namn: "Kalles korvkiosk",
    categories: ["Korv", "Hamburgare"],
    image: imageList[2],

    menu: [
      { namn: "Korv med bröd", pris: genereraRandomPris() },
  ...
  },
  {
    ...
    menu: [
      { namn: "Big Sushi", pris: genereraRandomPris() },
  ...
  {
    id: 3,
    namn: "Bertils Burgare",
    categories: ["Hamburgare", "Korv"],
    image: imageList[0],

    menu: [
      { namn: "FemOstburgare", pris: genereraRandomPris() },
...

  {
    ...
    menu: [
      { namn: "Pelles pasta", pris: genereraRandomPris() },
...

  {
    ...
    menu: [
      { namn: "Salladsrulle", pris: genereraRandomPris() },
...

  {
    ...
    menu: [
      { namn: "Bajsa blod i tre dagar", pris: genereraRandomPris() },
      { namn: "Ambulans på köpet", pris: genereraRandomPris() },
      { namn: "PadThai utan massage", pris: genereraRandomPris() },
      {
        namn: "Kyckllingspett med Nitroglycerinsås",
        pris: genereraRandomPris(),
      },
    ],
  },
];
